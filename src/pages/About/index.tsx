            ...
            <GeneralCard>
              <div className={styles.cardContent}>
                ...
                <p className={styles.cardParagraph}>
                  ...
                  <a href="http://claudiearseneault.com/?page_id=2107">
                    Aromantic
                  </a>{" "}
                  |{" "}
                  <a href="http://claudiearseneault.com/?page_id=2013">
                    Asexual
                  </a>
                </p>

                <p className={styles.cardParagraph}>
                  Hosting the database requires a monthly upkeep. If you use
                  this resource a lot, consider chipping in to help keep it
                  alive!
                </p>
                <a
            ...
            <GeneralCard>
              <div className={styles.cardContent}>
                ...
                <p className={styles.cardParagraph}>
                  ...
                  information on individual stories . Entries are separated in
                  two sections: the character and the stories they feature in.
                </p>
                  ...
                  <div className={styles.sideContainer}>
                    ...
                    <div className={styles.side}>
                      ...
                      <div>
                        ...
                        within the text. It should be showed or discussed to an
                        extent that makes it clear to the readers.
                      </div>
                    </div>
                    <div className={styles.side}>
                      <div>Word used</div>
